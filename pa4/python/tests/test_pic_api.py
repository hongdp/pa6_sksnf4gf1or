...
OR
python test_pic_api.py http://localhost:3000/sksnf4gf1or/pa3
'''
import sys
import unittest
...
if __name__ == "__main__":
    ...
    # Test Caption routes
    caption_tests = ['test_caption_get_basic', 'test_caption_get_blank_caption', 'test_caption_get_no_id',
                     'test_caption_get_invalid_id',
                     'test_caption_post_basic', 'test_caption_post_update', 'test_caption_post_no_caption_id',
                     'test_caption_post_no_id',
